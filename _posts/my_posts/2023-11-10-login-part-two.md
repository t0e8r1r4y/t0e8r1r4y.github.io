...
[참고자료](https://aws.amazon.com/ko/lambda/pricing/)
...
[참고자료](https://ko.wikipedia.org/wiki/OAuth)
...
관련 링크는 아래와 같다.
[참고자료](https://zibro.tistory.com/7)
...
- 주요 로그인 수단
  - 네이버
    - 네이버 디벨로퍼 센터
[참고자료](https://developers.naver.com/docs/login/devguide/devguide.md#3-4-4-접근-토큰-발급-요청)
  - 카카오
    - 카카오 디벨로퍼 센터
[참고자료](https://developers.kakao.com/)
  - 페이코 인증 서비스
  - 애플
  ...
  - 구글
    ...
    - 파이어 베이스
[참고자료](https://firebase.google.com/docs/admin/setup?hl=ko#java)
    - 구글 디벨로퍼 센터
[참고자료](https://developers.google.com/?hl=ko)
  - 페이스북(메타)
    - 메타 디벨로퍼 센터
[참고자료](https://developers.facebook.com/docs/facebook-login/guides/access-tokens#extending)
  - 라인
    - 라인 디벨로퍼 센터
[참고자료](https://developers.line.biz/en/)
- 특징
